...
public class DeviceName {
    ...
    public static String getDeviceName(String codename, String model, String fallback) {
        //TODO update from http://apps4android.org/eos/internal_code_name_060816.htm
        // ----------------------------------------------------------------------------
        // Acer
        ...
        if ((codename != null && (codename.equals("espresso10wifi")
                || codename.equals("espresso10rf")
                || codename.equals("espresso10spr")
                || codename.equals("espresso10tmo")
                || codename.equals("espresso10vzw")
                || codename.equals("espresso10can")
                || codename.equals("espresso10att")))) {
            return "Galaxy Tab2 10.1";
        }
        if ((codename != null && (codename.equals("espressowifi")
                || codename.equals("espressorf")
                || codename.equals("espressovzw")))) {
            return "Galaxy Tab2 7.0";
        }
        if ((codename != null && (codename.equals("gts210lte")
                || codename.equals("gts210lteatt")
                || codename.equals("gts210ltecan")
                || codename.equals("gts210ltekx")
                || codename.equals("gts210ltespr")
                || codename.equals("gts210ltetmo")
                || codename.equals("gts210ltevzw")
                || codename.equals("gts210velte")
                || codename.equals("gts210veltechn")
                || codename.equals("gts210vewifi")
                || codename.equals("gts210wifi")
                || codename.equals("gts210lteusc")))) {
            return "Galaxy Tab S2 9.7";
        }
        if ((codename != null && (codename.equals("gts28lte")
                || codename.equals("gts28ltechn")
                || codename.equals("gts28ltekx")
                || codename.equals("gts28velte")
                || codename.equals("gts28wifi")
                || codename.equals("gts28wifichn")))) {
            return "Galaxy Tab S2 8.0";
        }
